...
HOST = os.environ.get("HOST", "0.0.0.0" if IN_CODESPACES else "127.0.0.1")
PORT = int(os.environ.get("PORT", "8080" if IN_CODESPACES else "8765"))
...
def main() -> int:
    ...
    default_open_browser = "0" if IN_CODESPACES else "1"
    if os.environ.get("OPEN_BROWSER", default_open_browser) == "1":
